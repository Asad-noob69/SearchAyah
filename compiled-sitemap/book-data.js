...
exports.mainpageBooks = exports.iqbal = exports.TheologyMysticismCategory = exports.islamicJurisprudenceCategory = exports.philosophyCategory = exports.historyCategory = void 0;
exports.getBookById = getBookById;
// lib/book-data.ts
const mainpage_book_1 = require("./mainpage-book");
const historyBooks = [
    {
        "id": "bulugh-al-maram",
...
const islamicJurisprudenceBooks = [
    {
        "id": "usul-al-hanafi",
...
async function getBookById(category, bookId) {
    let books = [];
    switch (category) {
        case "iqbal":
            books = iqbalBooks;
...
exports.historyCategory = historyCategory;
const philosophyCategory = () => ({
    id: "philosophy",
    title: "Islamic Philosophy",
    books: philosophyBooks,
});
exports.philosophyCategory = philosophyCategory;
const islamicJurisprudenceCategory = () => ({
    id: "islamic-jurisprudence",
    title: "Islamic Jurisprudence",
    books: islamicJurisprudenceBooks.flatMap((cat) => cat.books),
});
exports.islamicJurisprudenceCategory = islamicJurisprudenceCategory;
const TheologyMysticismCategory = () => ({
    id: "theologynmysticism",
    title: "Theology & Mysticism",
    books: theologyMysticismBooks,
});
exports.TheologyMysticismCategory = TheologyMysticismCategory;
const iqbal = () => ({
    id: "iqbalCategory",
...
const mainpageBooks = () => [mainpage_book_1.quranBook, ...mainpage_book_1.bookCategories.flatMap((category) => category.books)];
exports.mainpageBooks = mainpageBooks;
