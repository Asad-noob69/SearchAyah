...
export async function generateMetadata({ params }: { params: Promise<{ bookId: string }> }) {
  ...
  try {
    ...
    console.error("Error generating metadata for Philosophy book:", error);
    return {
      title: "Book Not Found",
      description: "Book not found.",
...
export default async function BookPage({ params }: { params: Promise<{ bookId: string }> }) {
  ...
  try {
    ...
    console.log("Fetching Philosophy book from:", apiUrl.toString());
    ...
    console.error("Error loading Philosophy book page:", error);
    notFound();
  }
}
