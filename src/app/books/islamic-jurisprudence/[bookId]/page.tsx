  ...
  try {
    ...
    if (!response.ok) {
      return {
        ...
        keywords: "Islamic Jurisprudence, Hanafi Fiqh, Shafi'i Usul, Maliki, Hanbali, Usul al-Fiqh, Islamic Law Books",
      }
    }
    ...
    return {
      ...
      keywords: book?.keywords?.join(", ") || "Islamic Jurisprudence, Hanafi Fiqh, Shafi'i Usul, Maliki, Hanbali, Usul al-Fiqh, Islamic Law Books",
    }
  } catch (error) {
